...
*Última actualización (2026-08-13): **Slidenav** — `EVENTO_ADVERTIR_TRANSF_PENDIENTES` tras Elegir Usuario (aviso si Emisión/Recepción &gt; 0).*
