...
| Stock / Trans. Depósitos | Registrar y marcar transferido (`stock_trasn_depositos`); borrador de grilla en `localStorage` hasta Generar Transf.; prueba PUT ajuste stock DUX (`probarPutAjusteStockDuxAction`). Flujo vendedor. |
