...
- Sidebar **ASISTENTE IA** → **Buscar Código Desde Imagen** (`PERMISOS.asistenteIa.acceso`, **simple + editor**). **GESTION PROMP & URL** solo **editor**. Ruta URL legacy `buscar-color-imagen` (sin rename de path).
