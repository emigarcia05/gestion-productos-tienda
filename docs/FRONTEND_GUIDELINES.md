...
*Última actualización (2026-08-12): **Trans. Depósitos** — columna CONTROL (Check) + anti-duplicado 7 días (`prod_stock_transf_dep`); cabeceras solo nombre; flecha en origen.*
