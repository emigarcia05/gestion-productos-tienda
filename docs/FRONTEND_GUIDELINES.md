...
| `.sidebar-nav-tree` | Guía vertical **continua** del acordeón sidebar (mismo color en todos los niveles): `border-left` 2px, `color-mix` `#021D36` **45 %** sobre `#0072BB`. Aplicar al panel de cada `CollapsibleContent` abierto para leer de un vistazo la jerarquía.
