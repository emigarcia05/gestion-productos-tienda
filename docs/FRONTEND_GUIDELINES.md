...
| `.sidebar-nav-depth-1`, `.sidebar-nav-depth-2` / `SidebarNavDepthRail` | Línea vertical **2px** a la derecha del ícono (jerarquía del acordeón): misma escala `color-mix` `#021D36` sobre `#0072BB` — **16 %** (depth-1) y **30 %** (depth-2). |
...
*Última actualización (2026-08-06): **Sidebar · rail de profundidad** — jerarquía con línea vertical tras el ícono (`SidebarNavDepthRail` + `.sidebar-nav-depth-1`/`-2`); se retira el fondo degradé del panel.
