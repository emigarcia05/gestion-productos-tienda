...
- **Pendientes**: hover o click abren el detalle lateral; **Pedido** y **Transferencia** son botones (Generar Pedido / Trans. Depósitos con `origen` = sucursal preferida); badge = categorías con pendientes (máx. 2); `accent2` si hay Emisión o Recepción. Sin modal de aviso.
