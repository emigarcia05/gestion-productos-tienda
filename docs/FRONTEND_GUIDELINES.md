...
- **Estadísticas Productos** — SSOT `ESTADISTICAS_PRODUCTOS_ROUTES`; sidebar módulo **ESTADÍSTICAS** con **Carga de Datos** + **Categorizacion**. `/estadisticas-productos` → redirect a carga.
