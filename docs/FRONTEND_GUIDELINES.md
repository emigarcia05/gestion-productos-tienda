...
- **`/pedido-a-fabrica`** (**Pedido A Fábrica**): pilar sidebar **PEDIDO A FÁBRICA**; `PedidoAFabricaPageClient` (placeholder). Legacy **`/estadisticas-productos/est-para-compra`** → `permanentRedirect` a canónica.
