...
*Última actualización (2026-08-04): **Est. Por Prod · colores** — catálogo `est_por_prod_colores` + modal **Gestionar Colores**; match por nombre en descripción (`matchColoresEnDescripcion`).*
