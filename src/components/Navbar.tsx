...
const navLinks = [
  { href: "/gestion-productos/proveedores", label: "Lista Proveedores", icon: Building2 },
  { href: "/gestion-productos/tienda/comp-proveedores", label: "TiendaColor", icon: ShoppingBag },
