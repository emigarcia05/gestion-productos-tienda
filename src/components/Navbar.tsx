...
const navLinks = [
  { href: GP_ROUTES.analisisPrecios.listaProveedores.listaPrecios, label: "Lista Proveedores", icon: Building2 },
  { href: GP_ROUTES.analisisPrecios.cxYPxTienda.cxCompra, label: "TiendaColor", icon: ShoppingBag },
    ...
    <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="max-w-7xl mx-auto px-8">
        <div className="flex h-14 items-center gap-6">
          <Link href={GP_ROUTES.defaultEntry} className="flex items-center gap-2 font-semibold">
