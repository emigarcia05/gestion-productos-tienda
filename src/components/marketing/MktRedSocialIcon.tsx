...
function InstagramIcon({ className, ...props }: IconProps) {
  /** Glifo Meta: cámara con lente + punto (trazo, legible en tamaño chico). */
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
      ...
      {...props}
    >
      <rect x="2.25" y="2.25" width="19.5" height="19.5" rx="5.5" ry="5.5" />
...
export default function MktRedSocialIcon({
  ...
  if (key.includes("INSTAGRAM") || key.includes("INSTRAGRAM") || key.includes("INSTA") || key === "IG") {
