...
- **Servicio hechos** (`src/services/mktPublicaciones.service.ts`): `listarMktPublicacionesCalendario`, `crearMktPublicacion`. Actions: `src/actions/mktPublicaciones.ts`. Validación: `@/lib/validations/mktPublicaciones.ts`.
