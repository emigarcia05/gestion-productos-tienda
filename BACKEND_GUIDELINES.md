...
*Última actualización (2026-07-24): **Margen Contribución · categorías** — `fin_ana_mc_categorias` rangos sobre **M.C. PONDERADO**; overlay gráfico en **MC** (equivalente vía serie ponderada) y **MC_PONDERADO**.*
