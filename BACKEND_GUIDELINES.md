...
- **Migraciones**: `20260616120000_add_prod_precios_rex` (tabla base); `20260616130000_prod_precios_rex_id_proveedor` (FK + índice único); `20260616140000_prod_precios_provee_id_precio_rex` (columna FK); `20260616150000_prod_precios_rex_vinculo_n_a_uno` (drop UNIQUE → vínculo **N:1**).
