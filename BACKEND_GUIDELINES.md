...
- **`mkt_publi`** (Prisma `MktPublicacion`): hecho que referencia **de forma independiente** a red / tipo / contenido (`onDelete: Restrict` en las tres FK). No hay validación cruzada entre catálogos. Migraciones históricas: **`20260713180000`**, **`20260714120000`**, global contenido **`20260714140000`**, baja puente N:M **`20260714180000_mkt_catalogos_sin_relacion`** (elimina `mkt_publicaciones_tipo_contenido`).
