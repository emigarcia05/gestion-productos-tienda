...
| `@/lib/validations/finTesoreriaCheques.ts` | `crearFinTesoreriaChequeSchema`, `listarFinTesoreriaChequesPorCajaSchema`, `montoChequeTesoreriaSchema` (`fechaAcreditacion` como `YYYY-MM-DD`). |
