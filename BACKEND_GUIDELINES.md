...
- Consumidores actuales de las lecturas:
  ...
  - `getProveedores()`: `src/app/finanzas/balance/gastos/catalogo/page.tsx` (carga el payload completo para popular la 4ª columna "PROVEEDORES" del catálogo + el Select del modal de gasto en un solo roundtrip) y otros call sites transversales (Px. Vta. Sugeridos, Lista Px Proveedores, etc.).
