...
| Marketing | `MktPublicacionRed`, `MktPublicacionContenidoTipo`, `MktPublicacion`, `MktPublicacionIdeaSeccion`, `MktPublicacionIdeaDetalle` | `mkt_publi_tipo_redes`, `mkt_publi_tipo_contenido`, `mkt_publi`, `mkt_publi_ideas_secciones`, `mkt_publi_ideas_detalle` |
