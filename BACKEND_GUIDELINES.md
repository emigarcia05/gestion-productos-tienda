...
- **Tabla** `fin_bal_gasto_final` (Prisma: `FinBalGastoFinal`):
  ...
  - `plazo_pago_dias` (`INTEGER`): plazo de pago en días entre la fecha del gasto (devengo) y la fecha de pago/vencimiento. En alta/edición se valida como **obligatorio** en rango **0..30** (UI: **PLAZO DE PAGO**).
