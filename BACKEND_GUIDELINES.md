...
- **`mkt_publi`** (Prisma `MktPublicacion`): hecho de publicación. Campos: `fecha` (`DATE`, día del calendario; se define al crear desde el Calendario), `publicacion` (`TEXT`, contenido; default `''`), FKs independientes a red / tipo / contenido (`onDelete: Restrict`). Índice `mkt_publi_fecha_idx`. Migración columnas **`20260714260000_mkt_publi_fecha_publicacion`**. Históricas: **`20260713180000`**, **`20260714120000`**, **`20260714140000`**, baja puente N:M **`20260714180000`**, renombre **`20260714240000`**.
