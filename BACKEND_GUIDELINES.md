...
- `competenciaPreciosList.service.ts` — listado paginado (`PAGE_SIZE`) con vínculos por competidor por fila (`vinculosPorCompetencia`). La grilla agrega promedio/mín/máx en cliente vía `competenciaPreciosFilaResumen.ts`.
