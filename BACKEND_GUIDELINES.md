...
- **`revalidatePedidoUrgenteTrasCambioIvaSaldo`**: invalida **`/pedidos/urgente`**, **`/pedidos/enviar`** y **`/pedidos/reposicion`** tras cambios en Posición IVA (débito/crédito/saldo manual).
