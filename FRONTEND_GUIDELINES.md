...
*Última actualización (2026-07-24): **`NuevoItemTintometricoModal`** — una columna **SUCURSAL** → **PROVEEDOR** → **COD. TINTOMÉTRICO**; títulos solo como máscara (`placeholder`). Ver §2c Pedido Tintométrico.*
