...
- **Contraste de estados (Recepción):** pendiente (sin checklist) **`border-l-4 border-accent2`** + **`bg-accent/55`**; alineado cantidades sin checklist aún **`border-l-4 border-primary/80`** + **`bg-primary/22`**; verificado **`border-l-4 border-primary`** + **`bg-primary/12`** + círculo **`bg-primary/20`** en columna checklist; transición corta en hover.
