...
*Última actualización (2026-07-06): **Comp. Categorias — renombre tablas** — persistencia `DTO. EXTRA` / `DIF % REF. MAN.` en **`prod_comp_item_comparados`**; referencias competencia en **`prod_comp_item_referencia`**; migración **`20260706120000_rename_prod_comp_item_tables`**. UI sin cambios de contrato (`dtoExtraComparacion`, `difPxRefManualComparacion`).*
