...
- Sidebar (`LISTA TIENDA`) por rol:  
  ...
  - **simple**: `Vinculacion Con Prov.`, `Control Stock`, `Calc. Tintométrico`, `Calc. Litros` (sin contraseña editor; vincular/desvincular siguen solo **editor**)
...
*Última actualización (2026-05-27): **Vinculacion Con Prov.** — acceso **simple** (`PERMISOS.tienda.acceso` + `tabla.vinculos`); modal de vínculos en solo lectura para **simple** (sin vincular/desvincular).*
