...
| `.tabla-fin-ana-margen-contribucion`, `.tabla-mc-col-forma` | **Margen Contribución**: tabla **`w-max` / `max-content`**. Columna forma fija **`--tabla-mc-forma-width`** (**7,5 rem**). Celdas en **%** (base PX LISTA = 100). |
