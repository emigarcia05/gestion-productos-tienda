...
*Última actualización (2026-05-07): `/finanzas/balance/mensual` — la columna **Global** también muestra botón de **histórico** en la ranura izquierda del sublayout `30%/70%` (ranura derecha reservada para acciones de sucursal).*
