...
*Última actualización (2026-07-02): **Comp. Categorias — persistencia unificada** — `DTO. EXTRA` y `DIF % REF. MAN.` en tabla **`prod_comp_item`** (`ComparacionItem`); migración **`20260702120000_prod_comp_item_unify_ajustes`**. UI sin cambios de contrato (`dtoExtraComparacion`, `difPxRefManualComparacion`).*
