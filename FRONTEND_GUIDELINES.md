...
- **Carrusel de procesos** (`ProcesoInstructivoCarrusel`): layout en **4 filas** (`auto | auto | 7rem | 1fr`); carrete de pasos con máximo 3 números visibles (números: borde **#0072BB**, fondo gris `bg-muted`; solo las flechas usan `Button`); texto con scroll en altura fija; imagen sin fondo (`object-contain` máximo) y lightbox pantalla completa en `Dialog`.
