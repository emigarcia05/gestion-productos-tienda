...
| `.tabla-fin-ana-margen-contribucion`, `.tabla-mc-col-forma` | **Margen Contribución**: tabla **`w-max` / `max-content`**. Columna forma fija **`--tabla-mc-forma-width`** (**6,9 rem**, +15 % sobre 6 rem). Celdas en **%** (base PX LISTA = 100). |
...
*Última actualización (2026-07-23): **Margen Contribución · ancho forma** — `--tabla-mc-forma-width` de **6 rem** a **6,9 rem** (+15 %); columnas forma fijas.*
