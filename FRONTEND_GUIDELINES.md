...
- **Tabla `/pedidos/enviar` (columnas):** **CANT. PEDIR** (**10%**), **TIPO PEDIDO** (**15%**, valor de `pedidos_mercaderia.tipo_de_pedido`), **SUCURSAL** (**15%**, valor visible siempre en MAYÚSCULA) y **DESCRIPCIÓN** (**60%**).
