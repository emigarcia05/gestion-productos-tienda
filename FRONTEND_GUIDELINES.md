...
2. **Estilos**  
   ...
   - **Nunca duplicar utilidades por eje** dentro de la misma `className` (`px-2 px-3`, `min-w-[40rem] min-w-[44rem]`, `text-sm text-base`). Mantener **una sola** utilidad y aprovechar `cn()` para resolver overrides condicionales.  
...
- [ ] **Sin utilidades Tailwind duplicadas por eje** en una misma `className` (ej. `px-2 px-3`, `min-w-[a] min-w-[b]`, `text-sm text-base`): mantener una sola y usar `cn()` para overrides condicionales.
