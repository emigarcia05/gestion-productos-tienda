...
*Última actualización (2026-07-23): **Margen Contribución · gráfico checklist** — panel izquierdo: select métrica + tabla checkbox/forma/M.C% (sin multi-select); default **3 CUOTAS** marcado.*
