...
- **Carrusel de procesos** (`ProcesoInstructivoCarrusel`): layout en columna flex (título, carrete con borde, bloque texto+imagen con borde compartido);
