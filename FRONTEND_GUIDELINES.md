...
| `--tabla-thead-height`, `--tabla-body-row-min-height`, `--tabla-body-cell-padding-y`, `--tabla-body-cell-padding-x` | Altura oficial: **`--tabla-thead-height`** = **2.25rem** (encabezado compacto); filas cuerpo **2.25rem**; padding celdas vía **y/x**. No sobrescribir padding/height en celdas salvo patrones documentados (p. ej. vínculos). |
