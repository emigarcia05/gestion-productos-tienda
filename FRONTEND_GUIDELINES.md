...
| `TABLE_ROW_ICON_BUTTON_FILLED_BRAND_CLASS` (`@/lib/ui-classes`) | Botones **solo ícono** en **filas de tabla** (y equivalentes en modales de grilla): fondo **`#0072BB`**, ícono blanco, `size="icon"` + `variant="ghost"`. Sustituye el patrón prohibido outline + icon-xs neutro. |
...
*Última actualización (2026-05-05): en `TablaGastos` (Balance · Gastos), orden de acciones por fila: **Registrar Pago** → **Editar** → **Eliminar**.*
