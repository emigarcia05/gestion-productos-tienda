...
*Última actualización (2026-05-05): en `GastoUnicoBalanceModal` (carga eventual), el formulario incluye **MONTO**, **PAGADO** (con botón explícito **Marcar Pago Total** junto al input para copiar MONTO y marcar pago total), **FECHA DE GASTO** (obligatoria y acotada al período `mes/anio`) y **PLAZO DE PAGO** (`Select` 0..30). Si `PAGADO === MONTO`, **PLAZO DE PAGO** se bloquea y deja de ser obligatorio.*
