...
### Comp. Categorias — Comparacion — DTO. EXTRA Persistente

En el submódulo **Comparacion** (`src/components/proveedores/ComparacionCategoriasClient.tsx`, sidebar **Comp. Categorias**) el campo `DTO. EXTRA` es editable por ítem y se guarda en backend con `actualizarDtoExtraComparacionAction`.
