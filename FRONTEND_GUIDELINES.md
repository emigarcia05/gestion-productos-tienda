...
**Columna Referencia competencia** (`ComparacionReferenciaCompetenciaColumn`): grilla **COMP. 15 %** · **PRODUCTO 70 %** (`line-clamp-2`) · **PX. 10 %** · **basura 5 %** (`Trash2` quita la fila); selección única con **`CATALOGO_FINDER_ROW_SELECTED_CLASS`**; **+ Nuevo** agrega referencia.
