...
*Última actualización (2026-05-22): **`TablaTesoreriaCajas`** — columnas reordenadas y % de `<col>`; **ACCIONES**: **Editar monto** / **Ver cheques** (**CHEQUE**) / **Editar caja** / **Eliminar**; sin doble clic para monto en **editor**; rol **simple**: doble clic en **CHEQUE** → cheques. Ver §1 **`/finanzas/tesoreria`**.*
