...
*Última actualización (2026-04-23): **GASTO FINAL** — se permiten varias filas con el mismo gasto de catálogo + proveedor + sucursal (sin índice único en BD); `CrearEditarFinBalGastoFinalModal` lista todos los proveedores del modal sin filtrar asignaciones previas.*
