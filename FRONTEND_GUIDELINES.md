...
- **Lista de verificación / acciones:** el campo de la primera columna no admite tipeo; al abrir el pedido, **cant. recibida** puede estar vacía en backend (`null`) hasta la recepción: hay que usar **Editar** para cargar cantidad antes de **OK** si aún no hay valor persistido; **OK** con cantidad ya guardada confirma tal cual; **cesto** guarda **0** y confirma. **Registrar En Dux** al completar cierra el modal.
