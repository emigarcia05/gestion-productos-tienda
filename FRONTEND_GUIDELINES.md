...
*Última actualización (2026-05-23): **`/finanzas/tesoreria`** — filtros en orden **TIPO CAJA** → **ENTIDAD** → **TITULAR**; **`TablaTesoreriaCajas`**: una sola columna **TIPO · ENTIDAD · TITULAR** (concatenación con `etiquetaTipoCajaEnPantalla`); `<colgroup>` 18 % / 52 % / 20 % / 10 % (con **ACCIONES**). Ver §1 **`/finanzas/tesoreria`**.*

*Última actualización (2026-05-22): **`TablaTesoreriaCajas`** — columnas reordenadas y % de `<col>`; **ACCIONES**: **Editar monto** / **Ver cheques** (**CHEQUE**) / **Editar caja** / **Eliminar**; sin doble clic para monto en **editor**; rol **simple**: doble clic en **CHEQUE** → cheques. **`ActualizarMontoCajaTesoreriaModal`**: **MONTO** (`MontoArInput`) inicia vacío al abrir; **Guardar** deshabilitado hasta ingresar un monto distinto al persistido. Ver §1 **`/finanzas/tesoreria`**.*
