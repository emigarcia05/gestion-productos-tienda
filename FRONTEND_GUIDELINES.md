...
*Última actualización (2026-05-06): `/finanzas/balance/mensual` — cada celda de sucursal usa sublayout `30%` + `70%`; el 30% es `grid-cols-2` (histórico | desglose/edición) con botones relleno marca (`TABLE_ROW_ICON_BUTTON_FILLED_BRAND_CLASS`).*
