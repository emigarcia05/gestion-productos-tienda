...
*Última actualización (2026-06-19): **Lista Precios — toolbar** — orden: **Cotización U$S=** → **Crear Prod.** → **Edición Masiva** → **Exp. Lista** → **Imp. Lista** → **Imp. Lista PDF** → **Reglas Descuentos** (modal; permiso `gestionarReglasDescuentos`).*
