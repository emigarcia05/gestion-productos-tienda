...
- **Carrusel de procesos** (`ProcesoInstructivoCarrusel`): layout en **4 filas** (`auto | auto | 7rem | 1fr`); carrete de pasos con máximo 3 números visibles; texto con scroll en altura fija; imagen con lightbox en `Dialog`.
