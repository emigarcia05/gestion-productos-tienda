...
*Última actualización (2026-04-30): **GASTO FINAL** muestra campo **PLAZO DE PAGO** debajo de **DÍA DEVENGADO** en `CrearEditarFinBalGastoFinalModal`. Es obligatorio y solo acepta enteros del **1 al 30**. Se persiste en `fin_bal_gasto_final.vencimiento` y se usa para calcular vencimientos (`fechaDevengo + plazoPago`).*
