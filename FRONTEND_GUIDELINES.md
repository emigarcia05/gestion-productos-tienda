...
*Última actualización (2026-07-16): **Marketing · Objetivo** — submódulo PUBLICACIONES `/marketing/publicaciones/objetivo` (`MarketingObjetivosPageClient`); se quitó el modal **Gestionar Objetivos** del Calendario; Exportar a Sheets + Nuevo en header; filtros EJE/PERIODO; Cuadro De Mando del Calendario sigue evaluando objetivos.*
