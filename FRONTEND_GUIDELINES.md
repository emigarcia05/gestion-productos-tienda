...
7. **Nuevo modal con tabla**  
   ...
   - Si necesitás alinear un bloque inferior con las mismas columnas de la tabla, **no** usar `grid-cols` con porcentajes que superen 100% (ej. `9% + 62.5% + 10.5% + 10.5% + 15%`). Eso provoca desbordes y desplazamientos laterales. Usar `fr` proporcionales (ej. `grid-cols-[9fr_62.5fr_10.5fr_10.5fr_15fr]`) para mantener la proporción sin overflow.
