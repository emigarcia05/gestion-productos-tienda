...
*Última actualización (2026-07-15): **Google Sheets — Exportar Secciones** — botón `ExportarMktSeccionesGoogleSheetsButton` en header del Calendario (editor); sobrescribe pestaña **Secciones** (`id`, `idea_nombre`, `idea_resumen`). Ver BACKEND_GUIDELINES (Google Sheets).*
